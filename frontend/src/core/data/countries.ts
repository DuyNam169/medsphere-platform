// ============================================================
// countries.ts — src/core/data/countries.ts
// Danh sách đầy đủ quốc gia cho dropdown chọn mã vùng điện thoại.
// Dùng emoji flag (Unicode) — không cần asset ảnh.
// ============================================================

export interface Country {
  code: string;      // ISO 3166-1 alpha-2, dùng cho libphonenumber-js
  name: string;
  dialCode: string;
  flag: string;
}
...
export const defaultCountry: Country = countries[0]; // Việt Nam