...
public class LoginNotificationEmailBuilder {
    ...
    public Built build(String fullName, String ip, String userAgent,
                        Instant loginTime, String notMeUrl, String language) {
        Locale locale = Locale.forLanguageTag(language);

        String subject   = t("login_notification.subject", locale);
        String title     = t("login_notification.title", locale);
        String greeting  = t("login_notification.greeting", locale, fullName);
        String timeLabel = t("login_notification.time_label", locale);
        String ipLabel   = t("login_notification.ip_label", locale);
        String deviceLabel = t("login_notification.device_label", locale);
        String notMePrompt = t("login_notification.not_me_prompt", locale);
        String notMeButton = t("login_notification.not_me_button", locale);
        String ignore    = t("login_notification.ignore", locale);
        ...
        String body = """
            ...
            """.formatted(
                title, greeting,
                timeLabel, TIME_FORMAT.format(loginTime),
                ipLabel, ip,
